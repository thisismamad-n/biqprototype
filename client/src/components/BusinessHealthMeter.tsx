...
export default function BusinessHealthMeter({ sections, overallProgress }: BusinessHealthMeterProps) {
  return (
    <Card className="p-6" data-testid="business-health-meter">
      <div className="space-y-6">
        <div>
          <h2 className="text-lg font-semibold mb-2">Business Health</h2>
        ...
        <div className="flex flex-col items-center gap-4 py-4">
          <ProgressIndicator progress={overallProgress} size={120} strokeWidth={8} showPercentage />
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <HealthDot status={status} showPulse={status === "incomplete"} />
                  <div className="text-sm font-semibold w-12 text-right">{section.progress}%</div>
                  <ProgressIndicator progress={section.progress} size={32} strokeWidth={3} />
                </div>
              </div>
            );
          })}
